...
export default function TermsPage() {
  return (
    <section className={styles.termsPage}>
      ...
      <h2>제2조 (리뷰 작성 원칙)</h2>
      <ul>
        <li>실제 경험에 근거한 솔직하고 객관적인 리뷰 작성</li>
        <li>타인의 권리를 침해하거나 명예를 훼손하는 내용 금지</li>
        <li>허위 정보나 과장된 내용 작성 금지</li>
        <li>개인정보 보호를 위한 민감한 정보 노출 금지</li>
      </ul>

      <h2>제3조 (리뷰 관리)</h2>
      <ul>
        <li>부적절한 리뷰는 사전 통보 없이 삭제될 수 있음</li>
        <li>악의적인 리뷰 작성 시 서비스 이용이 제한될 수 있음</li>
      </ul>
